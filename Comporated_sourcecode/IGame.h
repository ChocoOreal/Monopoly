...
class IGame
{
    public:
        ...
        */
        ...
        //Query the proper name of the cell/player has id
        virtual string askStringName(const string &type, int id) = 0;

        //Query setting rule
        virtual int querySettingRule(const string &queryOp) = 0;
};
